...
export default function About() {
  return (
    <section
      className="min-h-screen p-4 bg-gradient-to-t from-slate-100 to-cyan-50  dark:text-gray-100 dark:bg-gradient-to-t dark:from-slate-800 dark:to-gray-950 text-slate-700 "
      id="about"
    >
