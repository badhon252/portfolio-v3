        ...
        "../../node_modules/pretty-format/build/plugins/Immutable.js"(e) {
          ...
          var t = vt(),
            ...
            y = (E, F, z, B, W, G, D) =>
              ++B > F.maxDepth
                ? m(b(D))
                : `${b(D) + v}{${(0, t.printIteratorEntries)(
                    E.entries(),
                    F,
                    z,
                    B,
          ...
          var _ = (E, F, z, B, W, G) => {
            ...
            O = (E, F, z, B, W, G) => {
              ...
              return ++B > F.maxDepth
                ...
                ? `${D + v}{${
                    E._iter || E._object
                      ? (0, t.printIteratorEntries)(E.entries(), F, z, B, W, G)
                      : d
                  }}`
                : `${D + v}[${
          ...
          function z(g, $, H, X, K, x) {
            ...
            return Te === "[object Arguments]"
              ...
              ? ne
                ...
                : `${
                    oe ||
                    (!$.printBasicPrototype && g.constructor.name === "Array")
                      ? ""
                      : `${g.constructor.name} `
              ...
              ? `[${d(g)}]`
              : `${
                  oe || (!$.printBasicPrototype && d(g) === "Object")
                    ? ""
                    : `${d(g)} `
                }{${(0, r.printObjectProperties)(g, $, H, X, K, D)}}`;
          }
          function B(g) {
